...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (role === user_interface_1.Role.ADMIN) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, 'Invalid role provided. Only RIDER or DRIVER roles are allowed.');
    }
    if (!email || !password) {
    ...
    const user = yield user_model_1.User.create(Object.assign({ email, password: hashedPassword, auths: [authProvider], role: role || user_interface_1.Role.RIDER }, rest));
    return user;
});
// update user
...
const getAllRiders = () => __awaiter(void 0, void 0, void 0, function* () {
    const riders = yield user_model_1.User.find({ role: user_interface_1.Role.RIDER });
    const totalRiders = yield user_model_1.User.countDocuments({ role: user_interface_1.Role.RIDER });
    return {
        data: riders,
        meta: {
            total: totalRiders,
