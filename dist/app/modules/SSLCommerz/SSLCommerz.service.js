...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = {
            ...
            store_passwd: env_1.envVars.SSL_STORE_PASSWORD,
            ...
            ipn_url: `${env_1.envVars.SSL_SUCCESS_BACKEND_URL}?status=ipn`,
            shipping_method: 'N/A',
            product_name: 'Tour',
...
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield (0, axios_1.default)({
            method: 'GET',
            url: `${env_1.envVars.SSL_VALIDATION_API}?val_id=${payload.val_id}&store_id=${env_1.envVars.SSL_STORE_ID}&store_passwd=${env_1.envVars.SSL_STORE_PASSWORD}`,
        });
